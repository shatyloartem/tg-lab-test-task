...
namespace Runtime.Physics.Handlers
{
    ...
    {
        public CyclicHandler(Rigidbody body, HelicopterSettings settings) : base(body, settings)
        { }
        ...
        public override void Step(ref FlightFrame frame)
        {
            ...
            Vector3 localTorque = Vector3.ClampMagnitude(frame.Control.LocalCyclicTorque, Settings._maximumCyclicTorque);
